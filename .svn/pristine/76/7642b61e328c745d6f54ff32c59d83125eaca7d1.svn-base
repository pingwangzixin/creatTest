                                        ...
                                        <div class="question_type clearfix">
                                            ...
                                            <div class="question_template fl">
                                                ...
                                                <div class="all_tem judge clearfix" v-if="quesI.quzType == 1">
                                                    ...
                                                    <ul class="fl">           
                                                        <li :class="quesI.questionContent[2] == '正确' ? 'active' : ''" @click="smallJudge(quesI.questionContent,'正确')">对</li>
                                                        <li :class="quesI.questionContent[2] == '错误' ? 'active' : ''" @click="smallJudge(quesI.questionContent,'错误')">错</li>
...
//				console.log(questionBox)
 		...
 		smallDelete (quesI,index,groupIndex,quesIndex){
 			//index：大题循环	groupIndex：题组循环  quesIndex：小题循环
			if(this.allData.analysisData[index].smallTitle[groupIndex].content.length <= 2){
...
// 			//console.log(this.allData.analysisData);
 		...
 		submitData (){
   			...
   			for(var i=0;i<this.allData.analysisData.length;i++){
   				for(var j=0;j<this.allData.analysisData[i].smallTitle.length;j++){
	   				for(var k=0;k<this.allData.analysisData[i].smallTitle[j].content.length;k++){
		   				for(var l=0;l<this.allData.analysisData[i].smallTitle[j].content[k].questionContent.length;l++){
//			   				console.log(this.allData.analysisData[i].smallTitle[j].content[k].questionContent[l])
			   			}
		   			}
	   			}
   			}
