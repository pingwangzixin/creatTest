...
//  window.UEDITOR_HOME_URL = "/src/assets/common/ueditor/";
	...
	window.UEDITOR_CONFIG = {
		...
		,
		newServerUrl : "/examPaper/file/ueditor/"
		...
		, /*
			 ...
			 * 'rowspacingbottom', 'lineheight', '|', 'directionalityltr',
			 * 'directionalityrtl', 'indent', '|', 'paragraph', 'fontfamily',
			 * 'fontsize', 'customstyle', 'insertcode', '|', 'justifyleft',
